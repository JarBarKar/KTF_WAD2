...
<body id="app" onload='populate_categories();call_api(1,"getRandom"); populate_carousel();'>
    ...
    <div id="sticky_top" style='position: sticky; z-index: 5;'>
      <nav class="navbar navbar-expand-lg navbar-light row" style ="background-color: #fa6464">
          ...
          <div class="container row" style="width:40%; margin-left : 80px">
              <div class="row">
                <form class="form-inline col-12 mb-2"  id='search_box'>
                    <input id='query_input' class="form-control mr-2 typeahead" type="search" placeholder="Find a recipe" aria-label="Search" style=" font-family: 'Itim',cursive;">
                    <button class="btn btn-sm btn-outline-dark my-2 my-sm-0" type="submit"  onClick="populate_searchbox();return false">Search</button>
                  </form>
      ...
      <div id="categories">
          <nav class="navbar navbar-expand-lg navbar-light row" style ="padding-top: 0; padding-left: 0; padding-right: 0; ">
            <button class="navbar-toggler bg-warning border-dark" type="button" data-toggle="collapse" data-target="#categoryNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation"style="margin-left: 33%">
